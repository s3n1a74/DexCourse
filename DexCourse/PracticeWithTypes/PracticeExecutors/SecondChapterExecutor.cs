...
public static class SecondChapterExecutor
{
    ...
    {
        var employeeTom = new Employee("Tom", new DateOnly(1978, 8, 2), "77712335",
            "CEO",1000, true);
        var employeeDin = new Employee("Din", new DateOnly(1974, 8, 2), "77712355",
            "CEO",1000, false);
        var employeeSam = new Employee("Sam", new DateOnly(1986, 8, 2), "77712356",
            "CEO",1000, false);
